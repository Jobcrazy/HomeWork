...
--
-- 使用表AUTO_INCREMENT `hw_admin`
--
ALTER TABLE `hw_admin`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID';

--
-- 使用表AUTO_INCREMENT `hw_course`
--
ALTER TABLE `hw_course`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Course ID';

--
-- 使用表AUTO_INCREMENT `hw_done`
--
ALTER TABLE `hw_done`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID';

--
-- 使用表AUTO_INCREMENT `hw_follow`
--
ALTER TABLE `hw_follow`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID';

--
-- 使用表AUTO_INCREMENT `hw_homework`
--
ALTER TABLE `hw_homework`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID';

--
-- 使用表AUTO_INCREMENT `hw_user`
--
ALTER TABLE `hw_user`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'User ID';

--
-- 使用表AUTO_INCREMENT `hw_volunteer`
--
ALTER TABLE `hw_volunteer`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID';
COMMIT;
